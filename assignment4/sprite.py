...
def gettexcoords():
    ...
    coords = [
        [0., 0.], # lower u, v texture coord
        [1., 1.], # upper u, v texture coord
        ]

    # TODO: compute texture coordinates based on sprite_index
    coords[0][0] = sprite_index[0] * SPRITE_STRIDE[0]
    coords[0][1] = sprite_index[1] * SPRITE_STRIDE[1]
    coords[1][0] = sprite_index[0] * SPRITE_STRIDE[0] + SPRITE_SIZE[0]
    coords[1][1] = sprite_index[1] * SPRITE_STRIDE[1] + SPRITE_SIZE[1]
